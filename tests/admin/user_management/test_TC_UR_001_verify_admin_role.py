...
@pytest.mark.sanity
def test_TC_UR_001_verify_admin_role(logged_in_admin, add_user_page, config, test_data):
    """
    Verify that the User Management search returns only users
    ...
    # Step 2: Search users using the Admin role filter
