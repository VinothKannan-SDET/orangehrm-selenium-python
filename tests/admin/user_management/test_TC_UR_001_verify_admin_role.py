...
@pytest.mark.sanity
def test_TC_UR_001_verify_admin_role(logged_in, logged_in_admin, add_user_page, config, test_data):
    ...
    assert len(error_list) == 0,f"Listed username not in Admin role : {error_list}"