...
@pytest.mark.sanity
def test_TC_UM_006_search_user_by_role_admin(logged_in_admin, add_user_page, config, test_data):
    """
    ...
    # Step 2: Search users using the configured Admin role
    ...
    # Step 4: Verify that every returned user has the expected Admin role
