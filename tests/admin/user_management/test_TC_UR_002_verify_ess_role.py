...
@pytest.mark.sanity
def test_TC_UR_002_verify_ess_role(logged_in_admin, add_user_page, config, test_data):
    """
    ...
    # Step 2: Search users using the ESS role filter
    ...
    # Step 4: Verify that all returned users have the ESS role
